		...
		return (
			<section className="container">
				...
				<div className="container__wrapper">
					...
					<p className="container__text">From&nbsp;2008 Stanislav created his own project&nbsp;&mdash; &laquo;S_TN&raquo;. Huge arsenal of&nbsp;musical gadgets provided new opportunities for the musician. For South of&nbsp;Russia it&nbsp;was a&nbsp;new wave of&nbsp;experimental music. Game Boys, NES and Commodore turned into a&nbsp;weapon of&nbsp;mass destruction on&nbsp;the dance floor into his hand.</p>
					<p className="container__text">Since 2010 year S_TN became a&nbsp;sound designer and composer&nbsp; for <a href="https://www.facebook.com/KintoGames/" target="_blank"  rel="noopener noreferrer">Kintogames</a>.</p>
				</div>
			</section>
		);
	}
